...
public class Script {
	 ...
	 */
	public static void mergeHiCTimingWithORI(String oriInputPath, String hicTimingInputPath, String hicTimingOriOutputFile, int threshold, int insertOption, boolean clean) {
