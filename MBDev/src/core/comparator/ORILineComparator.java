 ...
 * @version 0.1
 */
public class ORILineComparator implements Comparator<ORILine> {


	@Override
	public int compare(ORILine o1, ORILine o2) {
		...
		if (compare == 0) {
			compare = Integer.compare(o1.getStartPosition(), o2.getStartPosition());
			if (compare == 0) {
				compare = Integer.compare(o1.getStopPosition(), o2.getStopPosition());
			}
		}
